...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _FORWARDRESPONSEPROTO._serialized_end = 531
    _GENERATIONSERVICE._serialized_start = 534
    _GENERATIONSERVICE._serialized_end = 720
